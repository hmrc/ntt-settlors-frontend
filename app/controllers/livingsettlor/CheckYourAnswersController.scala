  ...
  def onPageLoad(): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      val answers: Seq[SummaryList.Row] = Seq(
              helper.isSettlorIndividualOrBusiness,
              helper.isSettlorLegallyIncapable,
              helper.whatIsBusinessName,
              helper.doYouKnowCountryOfHeadOffice,
              helper.whatIsCountryOfHeadOffice)
